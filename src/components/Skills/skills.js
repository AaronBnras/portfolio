...
const Skills = () => {
    return (
        <div className="overflow-hidden bg-blue-900 text-white">
            <section
                id="skills"
                className="overflow-hidden w-full max-w-8xl mx-auto flex flex-col justify-center text-center"
            >
                <span className="skillTitle text-5xl ml-1 pt-10 mb-6">
                    What I Do 🤔
                </span>
                ...
                <div className=" skillBars w-full max-w-8xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 justify-between h-auto gap-4 p-2">
                    <div className=" skillBar flex flex-col text-left bg-blue-950 m-6 p-8">
                        <div className="items-center justify-center mx-auto">
                            <img
                                src={WebApp}
                                alt="WEB-Development"
                                className="w-64 h-auto my-4 object-cover"
                            />
                        </div>
                        <div className="flex-shrink-0 text-white text-5xl font-bold mb-4 text-left">
                            01.
                        </div>
                    ...
                    <div className="skillBar flex flex-col bg-blue-950 m-6 p-8 text-left">
                        <div className="items-center justify-center  mx-auto">
                            <img
                                src={MobileApp}
                                alt="Mobile Development"
                                className="w-64 h-64 my-4 object-fill"
                            />
                            <div className="flex-shrink-0 text-white text-5xl font-bold mb-4 text-left">
                                02.
                            </div>
                            ...
                            <p className="text-sm lg:text-base text-gray-300 mt-4">
                                ...
                                applications that give flawless user experiences on all
                                platforms and help you grow your company, corporation, or
                                personal brand.
                            </p>
                        </div>
                    </div>
                    <div className="skillBar flex flex-col bg-blue-950 m-6 p-8 text-left">
                        <div className="items-center justify-center mx-auto">
                            <img
                                src={Design}
                                alt="Graphics Design"
                                className="w-64 h-64 my-4 object-contain"
                            />
                        </div>
                        <div className="flex-shrink-0 text-white text-5xl font-bold mb-4 text-left">
                            03.
